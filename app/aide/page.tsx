...
const steps = [
  ...
  },
  {
    ...
    body: 'Sur la carte du quiz, Lancer → choisissez le mode : challenge libre, double défi ou hackathon live (stickers et ambiance ; un second quiz est facultatif pour enchaîner). Puis code PIN et QR code.',
    href: '/dashboard',
    cta: 'Voir mes quiz',
  },
  {
